...
namespace TravelAgency.Data
{
    ...
    {
        private const string connectionString = @"Server=.;Database=SoftJail;Integrated Security=True;Encrypt=False;";
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Configure the many-to-one relationship between TourPackageGuide and TourPackage
            modelBuilder.Entity<TourPackageGuide>()
                .HasOne(tpg => tpg.TourPackage)
                .WithMany(tp => tp.TourPackagesGuides)
                .HasForeignKey(tpg => tpg.TourPackageId);

            // Configure the many-to-one relationship between TourPackageGuide and Guide
            modelBuilder.Entity<TourPackageGuide>()
